...
### (v0.7.0.12) - 2020-04-01

#### New Features

* LambdaSharp CLI
    * Compile projects with [_ReadyToRun_](https://docs.microsoft.com/en-us/dotnet/core/whats-new/dotnet-core-3-0#readytorun-images) optimization when targeting .NET Core 3.1 and running on _Amazon Linux 2_.
